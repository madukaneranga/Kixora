...
const PrivacyPolicy: React.FC = () => {
  const sections = [
    ...
    },
    {
      ...
      content: <p className="text-xs">We implement measures to secure personal information from loss, unauthorized access, use, alteration, and disclosure. No method of transmission or storage is 100% secure.</p>,
    },
    {
      title: "5. Your Rights and Choices",
      content: (
        <>
          <p className="text-xs">Depending on your location, you may have rights to access, correct, delete, or object to processing of your personal info.</p>

          <h3 className="text-sm font-semibold mt-3 mb-1">EU Users: GDPR Rights</h3>
          <ul className="list-disc list-inside space-y-1 text-xs">
          ...
          <h3 className="text-sm font-semibold mt-3 mb-1">California (US) Users: CCPA/CPRA Rights</h3>
          <ul className="list-disc list-inside space-y-1 text-xs">
            <li>Right to Know</li>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mt-2 text-xs">You can refuse cookies in your browser, but some parts of the Site may not work properly.</p>
        </>
      ),
    },
    {
      title: "7. Children's Privacy",
      content: <p className="text-xs">The Site is not for children under 13. We do not knowingly collect info from children under 13.</p>,
    },
    {
      title: "8. Changes to This Privacy Policy",
      content: <p className="text-xs">We may update this Privacy Policy. Updates will be posted on this page.</p>,
    },
    {
      title: "9. Contact Us",
      content: (
        <>
          <p className="text-xs">Email: <a href="mailto:inkixora@gmail.com" className="underline">inkixora@gmail.com</a></p>
          <p className="text-xs">Phone: <a href="tel:+94741285920" className="underline">+94 74 128 5920</a></p>
        </>
      ),
    },
  ];
    ...
    <div className="min-h-screen bg-black text-white px-4 py-4 sm:px-6 sm:py-6 md:px-8 md:py-8">
      ...
      {sections.map((section, idx) => (
        <div key={idx} className="p-3 border border-white space-y-2">
          ...
          <div className="text-xs space-y-2">{section.content}</div>
        </div>
      ))}
      </div>
    </div>
